...
public class RedisController {
	...
	//    "lastName" : "green"
	//}	
	//Spring Boot with Redis as Database and Cache | Redis Series Part2 (by Simple Programming) 
	@PostMapping
	...
	//redis should be running
	//testdata
	//http://localhost:8080/redis/14000
	
	//cashing
	//store the data into the cash and then send the response
	//do cashing unless the result id is less than 1200
